  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-20 min-h-[85vh]">
      <div className="mb-12 max-w-2xl">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 text-sm font-medium text-red-600 mb-6">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-zinc-900 mb-4 tracking-tight">Tech Deals & Flash Sale</h1>
      ...
      {deals.length === 0 ? (
        <div className="text-center py-24 bg-white/50 border border-zinc-200 rounded-3xl">
          <svg className="w-12 h-12 mx-auto text-zinc-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <p className="text-xl font-semibold text-zinc-900 mb-2">Tidak ada deals aktif saat ini</p>
