...
export default function Footer() {
  return (
    <footer className="border-t border-zinc-200 bg-white text-zinc-500 py-12 mt-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <Link href="/" className="font-extrabold text-xl text-zinc-900 tracking-tight">
          ...
          <div>
            <p className="font-semibold text-zinc-900 tracking-wide mb-4">Eksplorasi</p>
            <ul className="space-y-3 text-sm">
              <li><Link href="/" className="hover:text-primary-500 transition-colors">Beranda</Link></li>
              <li><Link href="/blog" className="hover:text-primary-500 transition-colors">Artikel & Review</Link></li>
              <li><Link href="/deals" className="hover:text-primary-500 transition-colors">Gadget Deals</Link></li>
            </ul>
          </div>
          <div>
            <p className="font-semibold text-zinc-900 tracking-wide mb-4">Afiliasi & Transparansi</p>
        ...
        <div className="mt-12 pt-8 border-t border-zinc-200 flex flex-col sm:flex-row items-center justify-between text-xs opacity-60">
